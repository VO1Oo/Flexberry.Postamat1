...
(
	...
	"СтатусПостамата" NVARCHAR2(11) NULL,
...
ALTER TABLE "Посылка"
	ADD CONSTRAINT "Посылка_FСген_1405" FOREIGN KEY ("СгенКод") REFERENCES "СгенКод" ("primaryKey");

CREATE INDEX "Посылка_IСгенКод" on "Посылка" ("СгенКод");
...
ALTER TABLE "СгенКод"
	ADD CONSTRAINT "СгенКод_FПольз_978" FOREIGN KEY ("Пользователь") REFERENCES "Пользователь" ("primaryKey");

CREATE INDEX "СгенКод_IПоль_6548" on "СгенКод" ("Пользователь");
